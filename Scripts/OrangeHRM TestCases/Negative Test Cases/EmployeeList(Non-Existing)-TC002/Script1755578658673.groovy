...
WebUI.setText(findTestObject('OrangeHRM Objects/employee-name-imput'), 'Rkhan')
...
WebUI.verifyElementVisible(findTestObject('OrangeHRM Objects/noRecordsFound-message'), FailureHandling.STOP_ON_FAILURE)

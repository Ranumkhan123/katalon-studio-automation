...
WebUI.setText(findTestObject('OrangeHRM Objects/input_Password_password'), GlobalVariable.password)

WebUI.click(findTestObject('OrangeHRM Objects/button_Password_oxd-button oxd-button--medi_8860b7'))

WebUI.waitForPageLoad(15)

WebUI.verifyElementText(findTestObject('OrangeHRM Objects/DashboardTextVerify'), 'Dashboard')
